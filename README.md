...
49. Vitest pakai globals (`globals: true`) + type support di TS (`vitest/globals`, `@testing-library/jest-dom`) biar tidak import API test berulang.
   Source:
   - https://vitest.dev/config/#globals

50. Coverage setup ditambah:
