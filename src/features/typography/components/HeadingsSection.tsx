...
<h3 className="text-ait-h3-bold text-ait-neutral-900">
  Heading 3 - Bold
</h3>
...
<h5 className="text-ait-h5-bold text-ait-neutral-900">
  Heading 5 - Bold
</h5>

<h5 className="text-ait-h5-semibold text-ait-neutral-900">
  Heading 5 - Semibold
</h5>

<h6 className="text-ait-h6 text-ait-neutral-900">
  Heading 6 - Regular
</h6>`;
    ...
    <section className="space-y-4">
      ...
      <div className="space-y-4">
        <div className="bg-ait-neutral-50 p-6 rounded-lg">
          <h1 className="text-ait-h1 text-ait-neutral-900">Heading 1 - Semibold</h1>
        ...
        <div className="bg-ait-neutral-50 p-6 rounded-lg">
          <h2 className="text-ait-h2-bold text-ait-neutral-900">Heading 2 - Bold</h2>
          <p className="text-ait-caption-md-regular text-ait-neutral-500 mt-2">
        ...
        <div className="bg-ait-neutral-50 p-6 rounded-lg">
          <h3 className="text-ait-h3-bold text-ait-neutral-900">Heading 3 - Bold</h3>
          <p className="text-ait-caption-md-regular text-ait-neutral-500 mt-2">
        ...
        <div className="bg-ait-neutral-50 p-6 rounded-lg">
          <h3 className="text-ait-h3-semibold text-ait-neutral-900">Heading 3 - Semibold</h3>
          <p className="text-ait-caption-md-regular text-ait-neutral-500 mt-2">
        ...
        <div className="bg-ait-neutral-50 p-6 rounded-lg">
          <h5 className="text-ait-h5-bold text-ait-neutral-900">Heading 5 - Bold</h5>
          <p className="text-ait-caption-md-regular text-ait-neutral-500 mt-2">
        ...
        <div className="bg-ait-neutral-50 p-6 rounded-lg">
          <h5 className="text-ait-h5-semibold text-ait-neutral-900">Heading 5 - Semibold</h5>
          <p className="text-ait-caption-md-regular text-ait-neutral-500 mt-2">
        ...
        <div className="bg-ait-neutral-50 p-6 rounded-lg">
          <h6 className="text-ait-h6 text-ait-neutral-900">Heading 6 - Regular</h6>
          <p className="text-ait-caption-md-regular text-ait-neutral-500 mt-2">
