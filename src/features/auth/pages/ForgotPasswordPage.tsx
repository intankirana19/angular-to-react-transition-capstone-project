    ...
    return (
      <div className="w-full max-w-md">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-success-200 rounded-full opacity-20 blur-3xl" />
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-success-200 rounded-full opacity-20 blur-3xl" />
        </div>

        <div className="relative bg-white rounded-2xl shadow-ait-xl p-8 border border-neutral-100">
          {/* Success Icon */}
          <div className="flex justify-center mb-6">
            <div className="w-20 h-20 bg-gradient-to-br from-success-500 to-success-700 rounded-full flex items-center justify-center shadow-lg">
          ...
          <div className="text-center mb-8">
            <h1 className="text-ait-h2-bold text-neutral-900 mb-3">Check Your Email</h1>
            <p className="text-ait-body-md-regular text-neutral-600 mb-2">
              We've sent a password reset link to:
            </p>
            <p className="text-ait-body-md-semibold text-primary-600 mb-4">{formData.email}</p>
            <p className="text-ait-body-sm-regular text-neutral-500 bg-neutral-50 p-4 rounded-lg">
  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="relative bg-white rounded-2xl shadow-ait-xl p-8 border border-neutral-100">
        ...
        <Link
          to="/login"
          className="inline-flex items-center gap-2 text-ait-body-sm-semibold text-primary-500 hover:text-primary-600 transition-colors mb-6 hover:underline"
        >
          <ArrowLeft className="w-4 h-4" />
          Back to Login
        </Link>
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-ait-h2-bold text-neutral-900 mb-2">Forgot Password?</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-ait-body-sm-regular text-neutral-500 bg-neutral-50 p-3 rounded-lg">
